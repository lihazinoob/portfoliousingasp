<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminportfolio.aspx.cs" Inherits="Portfolio_Final.adminportfolio" %>
...
<section class="about" id="about">
  ...
  <section class="academics" id="academics">
      ...
      <asp:Button ID="updateacademics" runat="server" Text="Update Academics" CssClass="update" OnClick="updateacademics_Click" />
  ...
  <div class="portfolio-container">
      ...
      <asp:Button ID="updateprojects" runat="server" Text="Update Projects" CssClass="update"/>
  ...
  <div class="adminlogin">
    <asp:Button ID="adminloginbutton" runat="server" Text="Admin Logout" CssClass="btn" OnClick="admin_logout"/>
  </div>
          <asp:Button ID="updatecontact" runat="server" CssClass="update" Text="Update Contact" ></asp:Button>
</footer>
